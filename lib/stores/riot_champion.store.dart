...
class RiotChampionStore extends _RiotChampionStoreBase with _$RiotChampionStore {
  RiotChampionStore(RiotResourcesService riotResourcesService, ApplicationDetailsStore applicationDetailsStore) : super(riotResourcesService, applicationDetailsStore);
}
...
abstract class _RiotChampionStoreBase with Store {
  ...
  _RiotChampionStoreBase(this._riotResourcesService, this._applicationDetailsStore);
