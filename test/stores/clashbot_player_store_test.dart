...
// Fake class
class ApplicationDetailsStoreMock extends Fake implements ApplicationDetailsStore {
...
void main() {
  ...
  test('Test computed Map for ClashTeams to Servers', () async {
    ...
    final clashPlayerStore = ClashPlayerStore(clashBotService, applicationDetailsStore);
    clashPlayerStore.selectedServers = ObservableList.of(["0"]);
    var clashTeam = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
  ...
  test('Test - computed list of Clash teams that are filtered by Server id', () async {
    // Create mock object.
    clashBotService = MockClashBotService();
    discordService = DiscordServiceMock();
    resourcesService = RiotResourcesServiceMock();
    ...
    final clashPlayerStore = ClashPlayerStore(clashBotService, applicationDetailsStore);
    clashPlayerStore.selectedServers = ObservableList.of(["0"]);
    var clashTeamOneServer1 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var clashTeamTwoServer2 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "12345", DateTime.now());
    var clashTeamThreeServer1 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var clashTeamFourServer2 = ClashTeam("2", "Some Name", "Awesome Sauce", "1", {}, "12345", DateTime.now());
    var list = List.of([
      clashTeamOneServer1,
      clashTeamTwoServer2,
    ...
    expectedList = expectedList.where((team) => team.serverId == "12345").toList();
    mockito.when(clashBotService.getClashTeams("1", [])).thenAnswer((_) async => list);
  ...
  test('Test - computed list of Clash teams that are filtered by Tournament Name', () async {
    // Create mock object.
    clashBotService = MockClashBotService();
    discordService = DiscordServiceMock();
    resourcesService = RiotResourcesServiceMock();
    ...
    final clashPlayerStore = ClashPlayerStore(clashBotService, applicationDetailsStore);
    clashPlayerStore.selectedServers = ObservableList.of(["0"]);
    var clashTeamOneTournament1 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var clashTeamTwoTournament1 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var clashTeamThreeTournament2 = ClashTeam("1", "Some Name", "Not so Awesome", "1", {}, "1234", DateTime.now());
    var clashTeamFourTournament1 = ClashTeam("2", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var list = List.of([
    ...
    var expectedList = [...list];
    expectedList = expectedList.where((team) => team.tournamentName == "Awesome Sauce").toList();
    mockito.when(clashBotService.getClashTeams("1", [])).thenAnswer((_) async => list);
  ...
  test('Test - computed list of Clash teams that are filtered by Server id and Tournament Name', () async {
    // Create mock object.
    clashBotService = MockClashBotService();
    discordService = DiscordServiceMock();
    resourcesService = RiotResourcesServiceMock();
    ...
    clashPlayerStore.selectedServers = ObservableList.of(["0"]);
    var clashTeamOneServer1 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var clashTeamTwoServer2 = ClashTeam("1", "Some Name", "Not so Awesome", "1", {}, "12345", DateTime.now());
    var clashTeamThreeServer1 = ClashTeam("1", "Some Name", "Not so Awesome", "1", {}, "1234", DateTime.now());
    var clashTeamFourServer2 = ClashTeam("2", "Some Name", "Awesome Sauce", "1", {}, "12345", DateTime.now());
    var list = List.of([
      clashTeamOneServer1,
      clashTeamTwoServer2,
    ...
    var expectedList = [...list];
    expectedList = expectedList.where((team) => team.serverId == "12345" && team.tournamentName == "Not so Awesome").toList();
    mockito.when(clashBotService.getClashTeams("1", [])).thenAnswer((_) async => list);
    clashPlayerStore.filterByServer("12345");
  ...
  test('Test - computed list of Clash teams that are filtered by Tournament Day', () async {
    // Create mock object.
    clashBotService = MockClashBotService();
    discordService = DiscordServiceMock();
    resourcesService = RiotResourcesServiceMock();
    ...
    clashPlayerStore.selectedServers = ObservableList.of(["0"]);
    var clashTeamOneServer1 = ClashTeam("1", "Some Name", "Awesome Sauce", "1", {}, "1234", DateTime.now());
    var clashTeamTwoServer2 = ClashTeam("1", "Some Name", "Not so Awesome", "2", {}, "12345", DateTime.now());
    var clashTeamThreeServer1 = ClashTeam("1", "Some Name", "Not so Awesome", "3", {}, "1234", DateTime.now());
    var clashTeamFourServer2 = ClashTeam("2", "Some Name", "Awesome Sauce", "1", {}, "12345", DateTime.now());
    var list = List.of([
      clashTeamOneServer1,
      clashTeamTwoServer2,
    ...
    var expectedList = [...list];
    expectedList = expectedList.where((team) => team.tournamentDay == "1").toList();
    mockito.when(clashBotService.getClashTeams("1", [])).thenAnswer((_) async => list);
